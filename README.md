...
[cooperator_eater](cooperator_eater/) | 16.0.1.0.1 |  | Eater configuration based on Share product
...
[pos_shift_partner_can_shop](pos_shift_partner_can_shop/) | 16.0.1.0.2 | <a href='https://github.com/remytms'><img src='https://github.com/remytms.png' width='32' height='32' style='border-radius:50%;' alt='remytms'/></a> | Display in the POS whether the partner can shop or not.
...
[shift_attendance](shift_attendance/) | 16.0.1.1.1 |  | Volunteer Timetable Management
...
[shift_portal](shift_portal/) | 16.0.1.2.0 |  | Show available shifts for regular and irregular workers on the website and let workers manage their shifts with an easy web interface.

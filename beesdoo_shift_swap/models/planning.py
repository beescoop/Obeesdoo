    ...
    def _generate_task_day(self):
        ...
        for shift in shifts:
            ...
            for exchange in exchanges:
                if (
                    shift.worker_id.name == False
                    and exchange.confirmed_tmpl_dated_id.template_id
            ...
            for record in people_exchanges:
                if (
                    shift.worker_id == record.first_request_id.worker_id
                    and record.first_request_id.exchanged_tmpl_dated_id.template_id
                    == shift.task_template_id
                    ...
                    shift.update(updated_data)
                if (
                    shift.worker_id == record.second_request_id.worker_id
                    and shift.task_template_id
                    == record.second_request_id.exchanged_tmpl_dated_id.template_id
                    and shift.start_time
